...
public static class HelpTopics
{
    ...
    [
        ...
        new("keep-settings", "General", "Keep existing settings",
            "The app remembers which ini values it wrote itself. On update those follow your current settings; " +
            "values a game's config already had, or that you changed in-game, are kept. New keys from a new OptiScaler release are added. " +
            "Off: every install starts from the release ini plus your settings only."),
